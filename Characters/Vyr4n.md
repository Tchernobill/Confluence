...
- **Gender:** Male
- **Pronouns:** He/Him
- **Species/Race:** Human (secretly virus-enhanced)
- **Ethnicity/Cultural Background:** Caucassian, slum-born third generation
...
- **Intimate parts:** 15cm long, medium to large thickness, uncut
- **Distinguishing Features (Scars, Tattoos, etc.):** 
  - Extensive pale scars on shoulders and arms from harsh scrapyard conditions
...
- **Core Personality Traits:** 
  ...
  - **Later Arcs**: Increasingly strategic, protective, mysteriously capable, charismatic, burdened by secrets
- **Strengths:** 
...
- **Weaknesses:** 
  ...
  - Difficulty maintaining genuine human connections due to hidden nature
- **Fears & Traumas:** 
  - **Primary**: Hurting loves ones, abandonment
...
- **Themes Associated with the Character (e.g., Redemption, Chaos vs. Order, Transhumanism):** 
  ...
  - **Trust and Vulnerability**: Sharing ultimate secrets as ultimate intimacy
  - **Power and Restraint**: Having god-like abilities while choosing to remain human
- **Potential Character Arcs:**
  - **Arc 1**: Learning to hide abilities while building first relationships
  - **Arc 2**: Managing transformation while protecting secret and loved ones
  - **Arc 3-4**: Building power while maintaining human facade and connections
  - **Arc 5-6**: Becoming legendary figure while bearing burden of hidden truth
  - **Later**: Finding peace with enhanced nature without losing human connections
- **Conflicts They Face (Internal & External):**
  - **Internal**: Isolation vs. connection while hiding true nature, human vs. enhanced identity
  - **External**: Corporate threats, rivals who don't understand his true capabilities, protecting his secret-keepers

### Secret Management Strategies

- **Public Persona**: Exceptionally gifted but human craftsman and leader
- **Cover Stories**: Attributes abilities to intense training, natural talent, and advanced equipment
- **Limiting Demonstrations**: Never shows full capabilities, always appears to be at his limits
- **Misdirection**: Encourages speculation about enhancement while pointing away from truth
- **Trust Circle**: Only 3-5 people know complete truth, each revelation serves narrative purpose
- **Emergency Protocols**: Plans for protecting secret if discovered or threatened
...
- [[Myth-Building and Reputation]]
- [[Power Concealment Strategies]]
- [[Viral Enhancement Progression]]
