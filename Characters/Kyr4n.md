...
aliases:
  ...
  - The Elder
DOB: 2086-01-01
archetype: The Fallen Visionary
gender: Male
mbti: INTJ
enneagram: 5w4
...
related_characters:
  ...
  - "[[03.Hobbies/Writing/Confluence/Characters/Riley]]"
evolution:
  - arc: 1
    age: 16
    role: Scavenger
    ...
    status: Alive
    key_change: Mother dies, discovers Sedh
  - arc: 2
    age: 23
    role: Victim / Patient
    alignment: Chaotic Good
    status: Infected/Transforming
    key_change: Betrayed by Frank, Virus integration
  - arc: 3
    age: 29
    role: Criminal Operator
    alignment: Chaotic Neutral
    status: Active (Dark)
    key_change: Isa leaves, embraces criminal identity
  - arc: 4
    age: 45
    role: Territory Leader
    alignment: Lawful Evil
    status: Active (Authoritarian)
    key_change: Total control, justification of violence
  - arc: 5
    age: 54
    role: The Unifier
    alignment: Lawful Neutral
    status: Active
    key_change: Riley's death, preparation for democracy
  - arc: 6
    age: 69
    role: The Elder / Environmentalist
    alignment: True Neutral
    status: Redeemed
    key_change: Abdicates power, heals environment
tags:
  - cast
  - protagonist
  - leader
  - enhanced
image: Attachments/Kyr4n.png
status: active
version: "1.0"
...
gantt
    title Kyr4n's Character Arc
    dateFormat  YYYY
    axisFormat  %Y
    
    section Identity
    Scavenger (Neutral Good)      :active,    2102, 2108
    The Victim (Chaotic Good)     :           2108, 2115
    The Ghost (Chaotic Neutral)   :crit,      2115, 2125
    The Slum Daemon (Lawful Evil) :crit,      2125, 2140
    The Elder (True Neutral)      :done,      2140, 2165
    
    section Relationships
    Isa (Partner)                 :           2108, 2115
    Isa (Estranged)               :after,     2115, 25y
    Isa (Polyamorous Reunion)     :           2140, 2165
```
